...
func show_menu() string {
        ...
        fmt.Println("\n\n---------Keatool---------\n\n")
        fmt.Print("Below options for reservations/static entries\n")
        fmt.Print("---------------------------------------------\n")
        ...
        fmt.Print("Below options of dynamic/pool entries\n")
        fmt.Print("-------------------------------------\n")
        fmt.Print("a) Search by IP Address\n")
        fmt.Print("b) Search by MAC Address\n")
        fmt.Print("c) Search by Host Name\n")
        fmt.Print("v) Search by VLAN ID\n")
        fmt.Print("------------------------------------\n")
